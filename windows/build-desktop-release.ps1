...
$setupOutputExe = Join-Path $repoRoot "windows\releases\MAINFLOW.Desktop.Setup.exe"
...
Copy-Item -Path (Join-Path $setupPublishDir "MAINFLOW.Desktop.Setup.exe") -Destination $setupOutputExe -Force
